        ...
        <div className="exercice-div">
          ...
          {finished && (
            <div className="exercicResultDiv">
              ...
              {Array.isArray(selectedTopic.data) &&
                dataSetIndex < selectedTopic.data.length - 1 && (
                  <button class="next-button" onClick={startNewDrill}>
                    {t("btnStartNew")}
                  </button>
                )}
              <div className="placeholder"></div>
              <button class="largeStopBtn" onClick={resetGame}>
                {t("btnTopics")}
              </button>
            </div>
          )}
