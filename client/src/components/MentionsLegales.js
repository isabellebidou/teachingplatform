const MentionsLegales = () => {
    ...
    return (
        <div className='page'>
            ...
            <p className='itemp'>
            Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l'économie numérique, il est précisé aux utilisateurs du site Izzy Speak English sont informés de l’identité des différentes parties impliquées dans sa mise en œuvre et son suivi.
</p>
...
Isabelle Bidou, résidant au 52 avenue de Choisy- 75013, France -  de nationalité française , née le 28/10/1971,  inscrite au R.C.S. de PARIS sous le numéro Paris does not apply,

Le numéro siren l’éditeur est : 103664934.
            ...
            <p className='itemp'>Le Directeur de la publication du Site est Isabelle Bidou.
