...
export const grammarRules = {
  "Present simple (affirmative, negative, interrogative)": {
    nameFr: "Présent simple (affirmatif, négatif, interrogatif)",
    rule: "Use the present simple for habits, routines, and permanent situations in affirmative or negative sentences or questions. Use do/does for negatives and questions. Use 's' in the 3rd person in affirmative sentences.",
    ruleFr: "Utilisez le présent simple pour exprimer des habitudes, routines et situations permanentes dans les phrases affirmatives ou négatives. Utilisez do/does pour les phrases négatives et interrogatives. Ajoutez 's' à la 3e personne du singulier.",
  ...
  "Question tags in the Present simple": {
    nameFr: "Les question tags au présent simple",
  ...
  "Modal verb: can vs must in questions, affirmative and negative sentences": {
    nameFr: "Verbes modaux : can vs must",
    rule: "Use 'can' for ability, 'must' for obligation. Negatives and questions require correct auxiliary forms.",
    ruleFr: "Utilisez 'can' pour la capacité, 'must' pour l'obligation. Les négations et questions nécessitent les bonnes formes auxiliaires.",
    ...
    detail: "Only generate sentences in the present tense. Only use can, can't, must, or mustn't. Do NOT use could, should, may, or any other modal verb."
  },

  "Present continuous (affirmative)": {
    nameFr: "Présent continu (affirmatif)",
    rule: "Use present continuous for actions happening now or temporary situations. Use am/is/are + verb+ing.",
    ruleFr: "Utilisez le présent continu pour des actions en cours ou des situations temporaires. Utilisez am/is/are + verbe+ing.",
  ...
  "Definite vs indefinite articles and the Ø article": {
    ...
    numberOfOptions: 3,
    examples: [
      "There is _________ cat in the garden. => There is a cat in the garden.",
      "There are two cats in the garden, one of them is black another is white. ________ black cat is sleeping. => The black cat is sleeping.",
      "________ Dogs are friendly animals. => Ø Dogs are friendly animals."
    ],
    commonErrors: [
  ...
  "Present simple vs present continuous": {
    ...
    ruleFr: "Utilisez le présent simple pour les habitudes, routines et situations permanentes. Utilisez le présent continu pour les actions en cours ou temporaires.",
    ...
    detail: 'Exactly one option needs to be in the Present simple and exactly one option in the present continuous.'
  },

  "Comparative adjectives: short vs long adjectives, regular vs irregular forms": {
    nameFr: "Adjectifs comparatifs : courts vs longs, réguliers vs irréguliers",
    rule: "Short adjectives take -er, long adjectives use 'more'. Irregular forms must be memorized.",
    ruleFr: "Les adjectifs courts prennent -er, les adjectifs longs utilisent 'more'. Les formes irrégulières doivent être mémorisées.",
    allowedAnswers: [],
    numberOfOptions: 3,
    examples: [
  ...
  "Superlative adjectives: short vs long adjectives, regular vs irregular forms": {
    nameFr: "Adjectifs superlatifs : courts vs longs, réguliers vs irréguliers",
    rule: "Short adjectives take 'the ...-est', long adjectives use 'the ...most'. Irregular forms must be memorized.",
    ruleFr: "Les adjectifs courts prennent 'the ...-est', les adjectifs longs utilisent 'the ...most'. Les formes irrégulières doivent être mémorisées.",
    allowedAnswers: [],
    numberOfOptions: 3,
    examples: [
  ...
  "Countable vs uncountable nouns and when to use some and any": {
    ...
    detail: 'One option needs some, one any, and one can be a/an with proper vowel/consonant rule.'
  },

  "Quantifiers: a lot of vs many, little vs few": {
    nameFr: "Quantifieurs : a lot of vs many, little vs few",
    rule: "Use quantifiers to express quantity. Many for countable nouns, much for uncountable, few for countable, little for uncountable.",
    ruleFr: "Utilisez des quantifieurs pour exprimer la quantité. Many pour les noms comptables, much pour les noms non comptables, few pour les noms comptables, little pour les noms non comptables.",
    ...
    detail: 'One option must use few/many, another must use much/little.'
  },
  ...
  "Past simple (regular verbs)": {
    ...
    detail: "The suggestion with its specific pronoun and presence or absence of not must match the correct answer."
  },

  "Past simple - regular and irregular verbs": {
    nameFr: "Prétérit simple - verbes réguliers et irréguliers",
    rule: "Use past simple for completed actions. Regular verbs add -ed. Irregular verbs use specific past forms. Use did/didn't for questions/negatives.",
    ruleFr: "Utilisez le prétérit simple pour des actions terminées. Les verbes réguliers prennent -ed. Les verbes irréguliers utilisent des formes spécifiques. Utilisez did/didn't pour questions et négations.",
    ...
    numberOfOptions: 3,
    examples: [
      "I (go) ________ to school yesterday. => I went to school yesterday.",
  ...
  "Wh- words: what, who, when, where in the present simple": {
    nameFr: "Mots interrogatifs : what, who, when, where",
    rule: "Read the answers and complete the questions with the correct wh- word.",
    ruleFr: "Lisez les réponses et complétez les questions avec le mot interrogatif approprié.",
    allowedAnswers: ["what", "who", "when", "where"],
    numberOfOptions: 3,
    examples: [
      "answer: in the garden - question: __________ is the dog? => Where is the dog?",
